...
After the review is complete and the user has resolved all decisions:
...
- Files touched (from the plan or Step 0 analysis)
...
3. If `ORCH_NOT_AVAILABLE` OR the task is small (< 8 files and < 2 phases):
Skip this section silently. Don't recommend orch for small tasks or when it's not installed.
