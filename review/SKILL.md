...
# Check for orch integration
_ORCH_AVAILABLE="false"
if [ -f ~/.claude/skills/gstack/orch/SKILL.md ]; then
  _ORCH_AVAILABLE="true"
fi
echo "ORCH_AVAILABLE: $_ORCH_AVAILABLE"
```
