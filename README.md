...
| `/sync-docs` | **Technical Writer** | Sync all documentation with reality. Discovers every markdown file, cross-references against code, updates anything stale. Works post-session or post-feature — no ship ceremony needed. |
...
/document-release, /sync-docs, /codex, /cso, /env-sync, /deps, /autoplan, /build, /orch, /pair-agent,
